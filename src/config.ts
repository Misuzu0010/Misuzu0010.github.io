...
export const siteConfig: SiteConfig = {
	title: "Misuzu0010",
	subtitle: "インターネットの果て",
	siteURL: "https://misuzu0010.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-18", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"/assets/desktop-banner/HIORI_e011b.webp",
				"/assets/desktop-banner/KURO_e013a.webp",
				"/assets/desktop-banner/MASHIRO_e102b.webp",
				"/assets/desktop-banner/MASHIRO_e104f.webp",
				"/assets/desktop-banner/NANA_e401f3.webp",
				"/assets/desktop-banner/KURO_e021e.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Misuzu0010",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/272728189",
					external: true,
...
export const musicPlayerConfig: MusicPlayerConfig = {
    ...
    // 香子兰魔法：庞大的 audio 数组已经被彻底消灭，转移到 data 目录下了！
    
    meting_api: "https://meting.mysqil.com/api?server=:server&type=:type&id=:id&auth=:auth&r=:r",
    id: "17909651459", // 既然是 local 模式，这些网易云配置放着当占位符就行，不用管
    server: "netease", 
    type: "playlist", 
};
